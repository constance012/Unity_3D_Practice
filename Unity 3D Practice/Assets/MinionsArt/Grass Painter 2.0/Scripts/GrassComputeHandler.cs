...
[ExecuteAlways]
public class GrassComputeHandler : MonoBehaviour
{
	[Header("Components")]
	...
	ShaderInteractorOld[] interactors;
	...
	private void SetGrassDataBase()
	{
		...
		interactors = (ShaderInteractorOld[])FindObjectsOfType(typeof(ShaderInteractorOld));
		...
		if (FadeInEditor || Application.isPlaying)
		{
